                      ...
                      std::vector<cv::DMatch> &matches, std::string descriptorType, std::string matcherType, std::string selectorType)
{
    ...
    cout << " FLANN match in " << 1000 * t / 1.0 << " ms, matched points m = "<< matches.size() << endl;
    }
    ...
    t = ((double)cv::getTickCount() - t) / cv::getTickFrequency();
    cout << " NN match in " << 1000 * t / 1.0 << " ms, matched points m = "<< matches.size()<< endl;
    }
    ...
    t = ((double)cv::getTickCount() - t) / cv::getTickFrequency();
    cout << " KNN match in " << 1000 * t / 1.0 << " ms, matched points m = "<< matches.size() << endl;
    }
}
